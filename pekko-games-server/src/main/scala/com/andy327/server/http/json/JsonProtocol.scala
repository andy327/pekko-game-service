...
import spray.json._
import org.apache.pekko.http.scaladsl.model.{HttpEntity, HttpResponse, ContentTypes, MediaTypes}
...
case class TicTacToeState(board: Vector[Vector[String]], currentPlayer: String, winner: Option[String], draw: Boolean) extends GameState
